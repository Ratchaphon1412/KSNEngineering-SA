...
<div class="flex justify-center items-center min-w-screen">
    <div class=" border-gray-300 w-1/2 h-1/2 p-20">
    <p class="text-4xl font-extrabold text-gray-900 text-center rounded-xl bg-blue-300 py-4 mb-9 dark:text-white">Task</p>
        <form>
          <div class="mb-6">
