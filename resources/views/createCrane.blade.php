        ...
        <div class="mx-auto w-full max-w-[550px] bg-white">
            <form class="py-4 px-9" wire:submit.prevent="save">
                ...
                <div class="mb-5">
                    ...
                    <label>
                        <input list="browsers" name="myBrowser" class="rounded-md border border-[#e0e0e0]" placeholder="type"></label>
                ...
                <div class="mb-5">
                    ...
                    <label>
                        <input list="browsers" name="myBrowser" class="rounded-md border border-[#e0e0e0]" placeholder="year"></label>
                    <datalist id="browsers">
                        <option value="1">
                        <option value="2">
                        <option value="3">
